...
describe('String#leetspeak') do
  it('returns a string as is when no leetspeak rules apply') do
    expect("fly".leetspeak).to(eq("fly"))
  end
  ...
  it('replaces every "e" in a string with a "3"') do
    expect("elephant here".leetspeak).to(eq("3l3phant h3r3"))
  end
  ...
  it('does NOT replace the first letter when it is an s or the first letter of a word') do
    expect("sass sass sass".leetspeak).to(eq("sazz sazz sazz"))
  end
